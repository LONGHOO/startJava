...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
		    ...
		    $("#realname").html(jsonData.realName);
		    $("#idNumber").html(jsonData.idNumber);
		    $("#sex").html(jsonData.sex);
		    $("#birthDate").html(jsonData.bornDate);
		    $("#address").html(jsonData.address);
		    $("#image1").attr("src",jsonData.image1);
		    $("#image2").attr("src",jsonData.image2);
		    $("#myModal").modal("show");
		});
