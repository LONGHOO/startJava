<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="systemmanage_detail">
			<li class="expBidRequestPage"><a href="/expBidRequestPage">发布体验金活动</a></li>
			<li class="expBidRequest_list"><a href="/expBidRequest_list">体验金管理</a></li>
			<li class="returnMoneyPage"><a href="/returnMoneyPage">体验金还款</a></li>
