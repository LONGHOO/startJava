...
public class BidRequest extends BaseDomain {
    ...
    public String getJsonString(){
        ...
        String result = JSON.toJSONStringWithDateFormat(map, "yyyy-MM-dd HH:mm:ss", SerializerFeature.WriteDateUseDateFormat);
        System.out.println(result);
        return JSON.toJSONString(map);
    }
    public String getBidRequestStateDisplay(){
        switch (bidRequestState){
            case Constants.BIDREQUEST_STATE_APPLY: return "待审核";
            ...
            case Constants.BIDREQUEST_STATE_APPROVE_PENDING_1: return "满标一审";
            case Constants.BIDREQUEST_STATE_APPROVE_PENDING_2: return "满标二审";
            case Constants.BIDREQUEST_STATE_REJECTED: return "满标审核拒绝";
            ...
            case Constants.BIDREQUEST_STATE_PUBLISH_REFUSE: return "发标审核拒绝";
        }
        return "未知";
    }
    ...
    public String getBidRequestTypeDisplay(){
        return bidRequestType==Constants.BIDREQUEST_TYPE_NORMAL?"信":"体";
    }
}