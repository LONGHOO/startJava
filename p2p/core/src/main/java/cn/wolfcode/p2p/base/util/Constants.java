...
public class Constants {
    ...
    //最小利率
    public static final BigDecimal BORROW_RATE_MIN = new BigDecimal("12");;
    // --------------------还款类型---------------------------
    ...
    //状态(系统发布体验金）
    public final static int BIDREQUEST_TYPE_PUBLISH = 1;
    ...
    /**-===================体验金相关=====================*/
    //注册送体验金
    public final static BigDecimal EXP_ACCOUNT_REGIESTER = new BigDecimal("500.0000");

    //体验金状态（投标，冻结）
    public final static int EXP_TYPE_FREEZED = 0;

    //体验金状态(标审核成功，金额减少）
    public final static int EXP_TYPE_SBUSTRCT = 1;

    //类型(系统赠送)
    public final static int EXP_STATE_NORMAL = 0;

    //类型(体验标还款）
    public final static int EXP_ACTIONTYPE_RETURN_MONEY = 1;
}
