				...
				<div class="col-sm-9">
					<form action="/iplog" name="searchForm" id="searchForm" class="form-inline" method="post">
						...
						<div class="form-group">
							<label>时间范围</label>
							<input type="text" class="form-control beginDate" onclick="WdatePicker()"  name="beginDate" value='${(qo.beginDate?string("yyyy-MM-dd"))!""}'/>
						</div>
						<div class="form-group">
							<label></label>
							<input type="text" class="form-control endDate" onclick="WdatePicker()"  name="endDate" value='${(qo.endDate?string("yyyy-MM-dd"))!""}'/>
						</div>
						<div class="form-group">
						    <label>状态</label>
