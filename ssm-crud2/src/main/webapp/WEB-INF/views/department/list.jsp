    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach items="${depts.list}" var="dept" varStatus="vs">
                    <tr>
                        <td>${vs.count}</td>
                        <td>${dept.name}</td>
                        <td>${dept.sn}</td>
                        <td>
                            <a class="btn btn-info btn-xs" href="/department/input.do?id=${dept.id}">
                                <span class="glyphicon glyphicon-pencil"></span> 编辑
                            </a>
                            <a href="/department/delete.do?id=${dept.id}" class="btn btn-danger btn-xs">
